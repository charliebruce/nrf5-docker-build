...
# Download NRF5 SDK v15.3.0 and extract nRF5 SDK to /nrf5/nRF5_SDK_15.3.0
RUN curl -SL https://developer.nordicsemi.com/nRF5_SDK/nRF5_SDK_v15.x.x/nRF5_SDK_15.3.0_59ac345.zip > /tmp/SDK_15.3.0.zip && \
mkdir -p /nrf5 && \
unzip -q /tmp/SDK_15.3.0.zip -d /nrf5 && \
mv /nrf5/nRF5_SDK_15.3.0_59ac345 /nrf5/nRF5_SDK_15.3.0 && \
rm /tmp/SDK_15.3.0.zip

# Add micro-ecc to SDK
RUN curl -SL https://github.com/kmackay/micro-ecc/archive/v1.0.zip > /tmp/micro-ecc_v1.0.zip && \
unzip -q /tmp/micro-ecc_v1.0.zip -d /nrf5/nRF5_SDK_15.3.0/external/micro-ecc && \
mv /nrf5/nRF5_SDK_15.3.0/external/micro-ecc/micro-ecc-1.0 /nrf5/nRF5_SDK_15.3.0/external/micro-ecc/micro-ecc && \
make -C /nrf5/nRF5_SDK_15.3.0/external/micro-ecc/nrf52hf_armgcc/armgcc && \
